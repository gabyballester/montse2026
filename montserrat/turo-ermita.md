# Ruta · Turó de l'Ermità *(100 Cims FEEC · 595 m)* · posible

**Cuándo:** mañana fresca **vie 21 o sáb 22** *(no el jue 20 = Sant Jeroni)*  
Bloque total puerta a puerta: **~2,5–3 h** si no os enrolláis en la cima.

Mirador de la **cara norte** de Montserrat (Sant Jeroni y agujas de frente).  
Track: [Wikiloc · Turó de l'Ermità 100 Cims FEEC](https://es.wikiloc.com/rutas-senderismo/turo-de-lermita-100-cims-feec-107498566)  
Inicio Maps (asfalto → pista / GR 4): [Carrer de les Agulles · Can Prat](https://goo.gl/maps/t4iewnWFWXcmxcV47)

**Plan ★:** hacer el track **al revés** (menos pendiente) · madrugar · cima + fotos **≤20 min** · vuelta al coche antes de que apriete el calor.
...
## Sentido: al revés ★ *(menos pendiente)*

El track Wikiloc sube primero por la pista desde Agulles y luego sigue hacia el cruce **GR 4 / Camí Ignasià** y baja al **punto final**.

| Plan | Cómo | Cuándo usarlo |
|------|------|----------------|
| **A · Al revés ★** | En Wikiloc: **Invertir ruta** · aparcar en el **final** del track · caminar hacia Agulles | Menos pendiente en subida · vuestra nota |
| **B · Ida/vuelta Agulles** | Parking en [Maps Agulles](https://goo.gl/maps/t4iewnWFWXcmxcV47) · subir a cima · **mismo camino** abajo | Más simple · un solo parking · un poco más de pendiente |
| **C · Track “tal cual”** | Empezar en Agulles · acabar en el final del GPS | Solo si tenéis 2 coches o los extremos quedan a **pocos min** a pie por asfalto |

**Con 1 coche (recomendado):**

1. Abríd el Wikiloc → mapa → mirad **dónde termina** el track.  
2. Si el final está cerca (misma urbanización Can Prat): aparcad ahí → **invertir** → acabáis en Agulles → **5–15 min** andando por calle al coche.  
3. Si el final queda lejos / no lo veis claro: **Plan B** (i/v desde Agulles) y no os compliquéis.
...
| **~10:30–10:45** | Coche · vuelta alojamiento / monestir | — |
| **~11:00–11:15** | Ducha / sombra / plan tarde | — |

**Presupuesto tiempo a pie:** 2 h movimiento + 20 min cima = **2 h 20** · margen +15 min = **2 h 35** tope en monte.  
Si a las **09:45** aún no habéis empezado a bajar → bajad ya (calor).

### Si llegáis más tarde (plan B horario)

| Salida a pie | Cima | Coche | Nota |
|--------------|------|-------|------|
| 08:15 | ~09:30 | ~10:45 | ★ Ideal |
| 09:00 | ~10:15 | ~11:30 | OK si nubes / fresco |
| ≥10:00 | ≥11:15 | ≥12:30 | Solo si no hace 32 °C · no ideal agosto |

---

## Cómo va la ruta *(sentido Wikiloc original)*
...
| **Encadenar Santa Cova** | Tarde OK si piernas bien | Solo si volvéis ~11:00 y descansáis |

**Veredicto:** ruta **corta, fácil y muy fotogénica**; el fallo típico es salir tarde o quedarse 45 min en la cima. Con el reloj de arriba encaja en media mañana.
...
| Qué | URL |
|-----|-----|
| Wikiloc (track) | https://es.wikiloc.com/rutas-senderismo/turo-de-lermita-100-cims-feec-107498566 |
| Parking / inicio Maps | https://goo.gl/maps/t4iewnWFWXcmxcV47 |
| Ficha FEEC 595 m | https://www.feec.cat/activitats/100-cims/cim/turo-de-lermita/ |
| Noticias / Plan Alfa | https://www.montserratvisita.com/es/actualidad/noticias |
| Guía similar (circular ~6,4 km) | https://rafayanes.com/ruta-turo-de-lermita-595-m-els-100-cims/ |
